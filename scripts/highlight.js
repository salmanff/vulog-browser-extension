...
function highlight(selString, container, selection, color) {
    ...
    focus = selection.focusNode //.cloneNode(true);
    ...
    */
    ...
    if (true || !alreadyHighlighted) { // removed alreadyHighlighted comncept as vulog has manual remove
        ...
        parent.innerHTML = content.replace(sanitizeRe, '');
    }
